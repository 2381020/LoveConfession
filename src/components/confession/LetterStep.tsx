  ...
  return (
    ...
    >
      <div className="w-full max-w-lg space-y-8">
        ...
        >
          Dari: <span className="text-white font-semibold">{data.senderName}</span>
        </motion.div>
        ...
        >
          ...
          >
            <Button
              ...
              variant="outline"
              size="lg"
              className="bg-white/15 backdrop-blur-sm border-white/30 text-white font-medium text-base px-8 py-6 rounded-full hover:bg-white/25 transition-all shadow-lg"
            >
